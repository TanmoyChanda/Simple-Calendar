    ...
    stages{
		...
		stage('Sign Apk and archive') {
			steps{
				...
				nexusArtifactUploader credentialsId: 'fa18aea1-3423-41d0-b55a-b1d319a9c5b4', groupId: 'admin', nexusUrl: '13.127.211.17:8081/nexus', nexusVersion: 'nexus2', protocol: 'http', repository: 'http://13.127.211.17:8081/nexus/content/repositories/releases/', version: '${BUILD_NUMBER}'
